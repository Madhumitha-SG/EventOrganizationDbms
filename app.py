...
def getEvents():
    ...
    if request.method == "POST":
        try:
            ...
            runQuery("INSERT INTO events(event_title,registration_price,participants,type_id,location_id,date) VALUES(\"{}\",{},{},{},{},\'{}\');".format(Name,fee,participants,Type, Location,Date))
...
def runQuery(query):
    ...
    try:
        db = mysql.connector.connect( host='localhost',database='eventmanagement',user='madhu',password='Madhu@123')
